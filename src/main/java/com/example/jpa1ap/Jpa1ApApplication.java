...
public class Jpa1ApApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		//patientRepository.save(
				//new Patient(null, "Houssam", new Date(), false, 19));
		/*patientRepository.save(
				new Patient(null, "Raze", new Date(), true, 199));
		patientRepository.save(
				new Patient(null, "Jett", new Date(), false, 16));
		patientRepository.save(
				new Patient(null, "KillJoy", new Date(), true, 666));
		patientRepository.save(
				new Patient(null, "Brim", new Date(), true, 450));
		patientRepository.save(
				new Patient(null, "Cypher", new Date(), true, 777));
*/
